...
class Pdfparser:
    def __init__(self):
        ...
        self.records = []
        self.sub_type = ''
        self.file = os.environ.get('file')
        self.page = os.environ.get('page_no')

    def parse_pdf(self):
        try:
            tables = camelot.read_pdf(self.file,pages=self.page)
            tab = tables[0].df
            ...
            for dat in range(2, len_json):
                ...
                if '\n' in data1[0]:
                    ...
                    if sub_type_list[0].isupper() is True:
                ...
                for hv in heading_values:
                    ...
                    value = None
                    if heading_values[hv] == 'P':
                        value = 'Permitted Use'
                    elif heading_values[hv] == 'L':
                        value = 'Limited Use'
                    elif heading_values[hv] == 'S':
                        value = 'Special Use'
                    elif heading_values[hv] == '--':
                        value = 'Use Not Permitted'
